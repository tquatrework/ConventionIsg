...
//$pdf->Cell(40);
$pdf->Cell(120,5,"CONVENTION DE STAGE ETUDIANT",0,1,'C');
$pdf->SetFont('Arial','',10);
//$pdf->Cell(60);
$pdf->Cell(60,5,utf8_decode("Etudiant majeur"),0,1,'C');
$pdf->SetFont('Arial','I',10);
$pdf->Cell(80,5,utf8_decode("(Stage effectué en France)"),0,1,'C');
$pdf->SetFont('Arial','B',10);
$pdf->Cell(80,5,utf8_decode("Année universitaire ".$annee_universitaire),0,1,'C');
$pdf->Ln();
$pdf->Ln();
...
$pdf->Cell(100,10,utf8_decode('CONVENTION DE STAGE ENTRE LES SOUSSIGNES, '),0,1);
$pdf->Cell(100,10,utf8_decode('Ci-après L\'ETABLISSEMENT D\'ENSEIGNEMENT, '),0,1);
$pdf->SetFont('Arial','',10);
$pdf->Cell(100,10,utf8_decode('L\'établissement privé d\'enseignement supérieur : '),0,1);
$pdf->Cell(100,10,utf8_decode($nom_etablissement),0,1);
...
$pdf->wid(60,5,utf8_decode("Mail : ".$identifiant),0,1);
$pdf->Ln();
...
$pdf->Ln();
$pdf->SetFont('Arial','B',10);
$pdf->Cell(100,10,utf8_decode('DUREE ET DEROULE DU STAGE, '),0,1);
$pdf->Ln();
...
$pdf->page($pdf,265);
$pdf->SetFont('Arial',"B",10);
$pdf->MultiCell(0,10,"Numéro de sécurité sociale du STAGIAIRE + nom et adresse postale de la caisse d’assurance maladie à contacter en cas d’accident (lieu de domicile du STAGIAIRE sauf exception) :\n",0,'J')
$pdf->MultiCell(0,15, $numero_securite_social."\nAssurance maladie ".$numero_rue_assurance." ".$adresse_caisse_assurance."\n".$code_postal_assurance." ".$ville_assurance."\n",1,'L');
