...
/*if($gratification == "0"){
    $pdf->wid("Le montant de la gratification est fixé à : ","$gratification euro",2,true);
    ...
    $pdf->wid("Le montant de la gratification est fixé à : ","$gratification euro(s) par $unite après lissage",2,true);
}else{
...
$pdf->page($pdf,270);
$pdf->gras();
$pdf->ligneLn("Article 5 bis - Accès aux droits des agents - Avantages");
$pdf->normal();
$pdf->mLigne("(Organisme de droit privé en France sauf en cas de règles particulières applicables dans certaines collectivités d'outre-mer françaises) :");
$pdf->page($pdf,270);
