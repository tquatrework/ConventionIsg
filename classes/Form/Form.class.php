...
class Form{
    ...
    public function ifCheck($t,$cond1,$cond2){
        if($t == $cond1){
            $checkedOui = "checked";
            $checkedNon = "";
            $hidden = "";
        ...
        return $array = array($checkedOui,$checkedNon,$hidden);
    }
    ...
    public function civilite(){
        $tab = $this->ifCheck($this->tab["civilite_stagiaire"],"Mme","M.");
        $checkedM= $tab[0];
        $checkedMme= $tab[1];
        ?>
        <div class="btn-group btn-group-toggle" data-toggle="buttons">
            <?php
            $this->checkbox("M.","M.",$checkedM,"civilite_stagiaire","M.","radio");
            $this->checkbox("Mme","Mme",$checkedMme,"civilite_stagiaire","Mme","radio");
            ?>
        </div>
        <?php
    }
    ...
    public function checkbox($label,$value,$checked,$name,$id,$type){
        if($name == "lundi" || $name == "mardi" || $name == "mercredi" || $name == "jeudi" || $name == "vendredi" || $name == "vendredi" || $name == "samedi"){
            $required = "";
        }else{
            $required = "required";
        }
        ...
        ?>
            <label class="btn btn-outline-secondary ">
                <input type="<?=$type?>" name="<?=$name?>" <?=$required?> value="<?=$value?>" id="<?=$id?>" <?=$checked?> ><?=$label?>
            </label>
        <?php
    }
