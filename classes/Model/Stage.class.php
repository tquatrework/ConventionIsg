...
class Stage extends Model
{
    ...
    public function selectAllForTableBis($idStage){
        $request = 'SELECT * FROM stage WHERE id_stage = :id';
    }

    public function requestFKeysStage($table,$id){
    if($table == "stage"){
    ...
    public function requestIdEntreprise($table,$id){
    if($table == "entreprise"){
    ...
    public function requestEntreprise($table,$id){
    if($table == "entreprise"){
    ...
    public function requestTuteur($table,$id){
    if($table == "tuteur"){
    ...
    public function requestReferent($table,$id){
    if($table == "referent"){
    ...
    public function requestIdEtablissement($table,$id){
    ...
    public function requestEtablissement($table,$id){
    if($table == "etablissement"){
    ...
    public function requestStagiaire($table,$id){
    if($table == "stagiaire"){
    ...
    public function errorMessage($table){
    ...
    public function devalidationMessage(){
    ...
    public function DemandeMessage(){
    echo "<span class='alert alert-success col'>Demande de validation envoyée</span>";
    }

    public function requestDateValidation($idStage){
