...
class Stage_pbm extends Controller
{
    ...
    public function devalidationStage(){
        ...
        $dateValidation = $this->model->requestDateValidation($idStage);
        $dateValidationOneMonth = strtotime($dateValidation." +1 month");
        ...
        if($dateNow < $dateValidationOneMonth || $dateValidation == NULL){
