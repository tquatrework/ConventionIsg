...
$pdf->mLigne("Pour les stages dont la durée est supérieure à deux mois et dans la limite de la durée maximale de 6 mois, des congés ou autorisations d'absence sont possibles.");
...
*/
$pdf->saut();
$pdf->mLigne("Pour toute autre interruption temporaire du stage (maladie, absence injustifiée…) l'organisme d'accueil avertit l'établissement d'enseignement par courrier.");
